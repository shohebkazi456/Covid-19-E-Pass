...
<body>
	...
	<center>
		...
		<div class="container">
			...
			<h5 style="text-align: center;">Remove User</h5><br>
				...
				<table class="table table-secondary table-bordered table-striped table-hover" style="color: black;">
				    ...
				    <tbody>
				        ...
				        <?php
							...
							class AllUsers extends Covid_19_db
							{
								...
								public function retriveusers()
								{
									...
									while($res=mysqli_fetch_array($query))
									{
										...
										echo '<td>
											<a href="removed.php?id='.$res['userid'].'"><button type="button" class="btn btn-outline-danger">Remove</button></a>
										</td></tr>';
